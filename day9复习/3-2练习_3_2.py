...
def detect_faces(image_path):
    # face_cascade = cv.CascadeClassifier('D:/anaconda3/envs/Python3.12/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
